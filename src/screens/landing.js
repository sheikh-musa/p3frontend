	...
	return (
		<Row>
			...
			<Col className='bg-warning' sm={5}>
				<h1 className='text-light fw-bold px-5 pt-5 mt-3 mx-5'>
					STAY FOCUS AND ORGANIZED
				</h1>
				<h2 class='text-dark fw-bold px-5 py-3 mx-5'>
					Simply drag and drop <br /> your things to do, and get more things
					done
				</h2>

				<div className='px-5'>
					<Button
						className='fw-bolder rounded-pill mt-2 mb-5 mx-5 px-5'
